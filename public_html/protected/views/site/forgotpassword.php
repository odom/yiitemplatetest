<form class="form-horizontal" method="post" action="/user/getMailRecoveryPassword">
	<fieldset>
<div id="forgot">
	...
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="email" name="email" placeholder="Alternative email" class="form-control input-md" type="email">
